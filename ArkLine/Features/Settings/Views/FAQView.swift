...
struct FAQView: View {
    ...
    let faqs = [
        ...
        FAQItem(question: "What is the ArkLine Score?", answer: "The ArkLine Score is a proprietary metric that combines macro indicators (DXY, M2, VIX, WTI), sentiment data, and on-chain signals to give you an overall picture of market risk. It updates daily and is displayed on your Home Screen."),
        ...
        FAQItem(question: "What are Risk Coins?", answer: "Risk Coins let you choose which assets display risk level widgets on your Home Screen. You can pick any combination of supported crypto and stocks. Go to Settings > Risk Coins to customize."),
