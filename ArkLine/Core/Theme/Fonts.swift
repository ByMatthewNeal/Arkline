...
struct AppFonts {
    ...
    static let body16Medium = interFont(size: 16, weight: .medium)
    static let body16 = interFont(size: 16, weight: .regular)
    ...
    static let caption13 = interFont(size: 13, weight: .regular)
